...
class _MyAppState extends State<VoiceRecordScreen> {
  ...
  // In this simple example, we just load a file in memory.This is stupid but just for VoiceRecordScreennstration  of startPlayerFromBuffer()
...
*/
  ...
  Widget build(BuildContext context) {
              ...
              SizedBox(
                ...
                child: ClipOval(
                  child: TextButton(
                    ...
                    //padding: EdgeInsets.all(8.0),
                    child: Icon(
                      recorderModule.isPaused ? Icons.play_arrow : Icons.pause,
                      color: Colors.black,
                    ),
                  ),
                ),
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Flutter Sound VoiceRecordScreen'),
      ),
      body: ListView(
        children: <Widget>[
          recorderSection,
