...
class AppUpdateScreen extends StatefulWidget {
  ManifestModel manifestService = ManifestModel();

  AppUpdateScreen(this.manifestService, {super.key});
...
class _AppUpdateScreenState extends State<AppUpdateScreen> {
  ...
  Future<void> _fetchManifest() async {
    ...
    try {
      final data = widget.manifestService;
    } catch (e) {
      ...
      child: _buildGlassContainer(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: FxText(
                'Version ${m.APP_VERSION}', // Display version number
            ...
            _buildDownloadButton(
              ...
              onPressed: () {
                ...
                final number = m.WHATSAPP_CONTAT_NUMBER.replaceAll('+', '');
...
class AppConfig {
  // Assume logo path is defined here
  static const String logo_1 =
      'assets/images/logo.png'; // Example path, ensure it exists
}
