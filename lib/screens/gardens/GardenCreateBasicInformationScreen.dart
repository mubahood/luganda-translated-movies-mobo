...
class GardenCreateBasicInformationScreen extends StatefulWidget {
  ...
  GardenCreateBasicInformationScreen(this.garden, {Key? key}) : super(key: key);
                      ...
                      child: Column(
                        children: [
                          ...
                          FormBuilderDateTimePicker(
                            ...
                            name: "created_at",
                            initialValue:
                                widget.garden.created_at.isEmpty
                                    ? DateTime.now()
                          ...
                          FormBuilderTextField(
                            decoration: CustomTheme.in_3(
                              label: GetStringUtils("Garden name").capitalize!,
                            ),
                          ...
                          FormBuilderTextField(
                            decoration: CustomTheme.in_3(
                              label:
                                  GetStringUtils("Garden Details").capitalize!,
                            ),
                ...
                FxContainer(
                  ...
                  child: FxButton.block(
                    ...
                    child: Row(
                      ...
                      children: [
                        FxText.titleLarge('SAVE', color: Colors.white),
                        const SizedBox(width: 10),
                        const Icon(FeatherIcons.check, color: Colors.white),
                      ],
                    ),
                  ),
                ),
