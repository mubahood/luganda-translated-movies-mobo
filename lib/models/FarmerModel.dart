...
class FarmerModel {
  ...
  static fromJson(dynamic m) {
    ...
    obj.other_economic_activity = Utils.to_str(m['other_economic_activity'],'');
    ...
    obj.land_under_farming_in_acres = Utils.to_str(m['land_under_farming_in_acres'],'');
    ...
    obj.land_registration_numbers = Utils.to_str(m['land_registration_numbers'],'');
    ...
    obj.has_mobile_money_account = Utils.to_str(m['has_mobile_money_account'],'');
    obj.payments_or_transfers = Utils.to_str(m['payments_or_transfers'],'');
    obj.financial_service_provider = Utils.to_str(m['financial_service_provider'],'');
  ...
  static Future<List<FarmerModel>> getLocalData({String where = "1"}) async {
    ...
    List.generate(maps.length, (i) {
      data.add(FarmerModel.fromJson(maps[i]));
    });
  ...
  static Future<List<FarmerModel>> get_items({String where = '1'}) async {
  ...
  static Future<List<FarmerModel>> getOnlineItems() async {
    ...
    RespondModel resp =
    RespondModel(await Utils.http_get(FarmerModel.end_point, {}));
  ...
  static deleteAll() async {
    ...
    await db.delete(FarmerModel.tableName);
  }
